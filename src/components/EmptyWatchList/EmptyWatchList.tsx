...
import { AddCoinModal } from '../components';
...
export const EmptyWatchList: FC = () => {
    const {modalVisible, toogleModal} = useWatchListModal(false);
    return (
        <ModalContext.Provider value={{modalVisible, toogleModal}}>
...
const WatchListMessage: FC = () => {
    ...
    return (
        <div className={styles.message}>
            ...
            <Button type="primary" className={styles.button} onClick={toogleModal}>Add cryptocurrencies</Button>
        </div>
    )
}