...
import { formatCrypto, formatPercent, formatSupply, formatUSD } from "../../../../utils/formatters"
    ...
    return (
        <>
            ...
            <Row>
                <Col span={24}>
                    <Card>
                        <CoinGlobalSummary value={totalSupply} tooltip={'Total Supply:'} formater={formatSupply} />
                        <CoinGlobalSummary value={volume / marketCap} tooltip={'Volume/Market Cap:'} formater={formatCrypto} />
                    </Card>
                </Col>
            </Row>
        </>
