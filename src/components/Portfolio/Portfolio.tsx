...
const Portfolio:FC = () => {
    ...
    const [errorSelectedCoinForTrade, setErrorSelectedCoinForTrade] = useState<boolean>(false)
    ...
    const colorChange = (value: string) => value.split('-').length > 1 ? 'red' : 'green'
        ...
        <div className={styles.rightSide}>
            ...
            >
                ...
                <Margin vertical={MARGIN.l}>
                    <SearchEngine getId/>
                    {errorSelectedCoinForTrade && <Text style={{color: "red", margin: 5}}>You need selected coin</Text>}
                </Margin>
